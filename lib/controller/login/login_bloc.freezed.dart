...
class _$_Login implements _Login {
  const _$_Login({required this.phone, required this.countryCode});
  ...
  @override
  String toString() {
    return 'LoginEvent.login(phone: $phone, countryCode: $countryCode)';
  }
...
abstract class _Login implements LoginEvent {
  const factory _Login(
      ...
      required final String countryCode}) = _$_Login;
...
mixin _$LoginState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(LoginModel logindata) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(LoginModel logindata)? loaded,
...
class _$_Loaded implements _Loaded {
  const _$_Loaded({required this.logindata});
  ...
  @override
  String toString() {
    return 'LoginState.loaded(logindata: $logindata)';
  }
...
abstract class _Loaded implements LoginState {
  const factory _Loaded({required final LoginModel logindata}) = _$_Loaded;
